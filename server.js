...
app.post('/api/admin/produtos', exigirAdmin, async (req, res) => {
  const { nome, categoria, preco, material, nota } = req.body;
  ...
  try {
    ...
    await pool.query(
      'INSERT INTO produtos (id, nome, categoria, preco, material, nota) VALUES ($1,$2,$3,$4,$5,$6)',
      [idFinal, nome, categoria, precoNum, material || null, nota || null]
    );
...
app.put('/api/admin/produtos/:id', exigirAdmin, async (req, res) => {
  ...
  try {
    const resultado = await pool.query(
      'UPDATE produtos SET nome=$1, categoria=$2, preco=$3, material=$4, nota=$5 WHERE id=$6',
      [nome, categoria, precoNum, material || null, nota || null, id]
    );
